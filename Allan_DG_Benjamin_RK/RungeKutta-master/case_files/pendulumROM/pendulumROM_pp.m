...
% u_plot contains the solution to the reduced order model
% the full order model is approximated by V*u
U_FOM    = options.model.V*u_plot;
theta    = U_FOM(1,:); %u_plot(1,:);
dthetadt = U_FOM(2,:); %u_plot(2,:);
% theta    = u_plot(1,:);
% dthetadt = u_plot(2,:);
